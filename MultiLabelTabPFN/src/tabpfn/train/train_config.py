...
def build_parser():
    ...
    parser.add_argument("--num_buckets", type=int, default=1000, help="Number of buckets for feature bucketing.")
    #parser.add_argument("--max_num_features", type=int, default=85,
    #                    help="Maximum number of features in the dataset.")
    parser.add_argument("--feature_attention_type", type=str, default="full", choices=["full", "linear", "mamba"],
